...
const VARIANTS: Record<ChefeStatus, Variant> = {
  available: {
    ...
    ring: "rgba(0,255,136,0.6)",
    bg: "radial-gradient(120% 100% at 0% 0%, rgba(0,255,136,0.22), rgba(10,20,15,0.88))",
  ...
  busy: {
    ...
    ring: "rgba(255,140,0,0.6)",
    bg: "radial-gradient(120% 100% at 100% 0%, rgba(255,170,0,0.22), rgba(255,90,0,0.12), rgba(20,10,5,0.9))",
